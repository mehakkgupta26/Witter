...
import com.example.witter.models.post as model


class PostAdapter(options: FirestoreRecyclerOptions<model>, val listener: IPostAdapter) : FirestoreRecyclerAdapter<model,PostAdapter.PostViewHolder>(
    options
){
    ...
    override fun onBindViewHolder(holder: PostViewHolder, position: Int, model: model) {
